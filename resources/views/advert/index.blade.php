...
@section('content')
    <div class="content-inner advert">
        ...
        <div class="a-block mb-20">
                ...
                <form action="{{route('advert.index', app()->getLocale())}}" method="get">
                    <div class="form-group mb-0">
						<div class="cols w-mob">
							...
							<div class="col-item col-g"><button type="submit" class="a-button b-orange b-block">{{__('adnetwork.search')}}</button></div>
						</div>
					</div>
                </form>
            </div>
			...
			<div class="a-block">
				<div class="a-block-head with-b">{{__('adnetwork.ad_list')}}
						...
						<div class="table-responsive">
							<table class="table">
								...
								<tr>
									...
									<th class="mw-200">{{__('adnetwork.ad_list')}}</th>
