                    ...
                    <div class="lp-content">
                        ...
                        <div class="lp-col">
                            <div class="lp-right">
                                ...
                                <div class="lp-form">
                                    <form method="post" action="{{route('publisher_login', app()->getLocale())}}">
                                        @csrf
                                        @include('flash-message')
                                        <div class="lp-input mail">
                                            <input  class="@error('email') input-error @enderror" type="text" placeholder="{{__('user.email')}}" id="username" name="email" value="{{old('email')}}">
                                        </div>
                                        @error('email')
                                        ...
                                        <div class="inp-bottom">
                                            ...
                                            <div class="forget">
                                                <a href="{{route('publisher_password', app()->getLocale())}}">{{__('adnetwork.reset_pass')}}</a>
                                            </div>
                                        </div>
